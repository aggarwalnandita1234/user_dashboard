...
routes['GET']['/start']='Users#start'
routes['GET']['/register']='Users#register'
routes['GET']['/dashboard']='Users#display_user'
routes['GET']['/dashboard/admin']='Users#display_admin'
routes['GET']['/users/new']='Users#admin_user_add'
